...
import '../../../features/patient/booking/data/appointment_model.dart';
...
class FirebaseProvider {
  ...
  static Future<void> markAppointmentComplete(String id) async {
    await appointmentsCollection.doc(id).update({'isComplete': true});
  }
