...
class AccountInfopatientScreen extends StatefulWidget {
  const AccountInfopatientScreen({super.key});

  @override
  _AccountInfopatientScreenState createState() =>
      _AccountInfopatientScreenState();
}

class _AccountInfopatientScreenState extends State<AccountInfopatientScreen> {
